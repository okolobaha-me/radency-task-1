...
export function renderNote(name, category, content, dates, elem) {
  const row = `<tr data-category="${category}" data-isArchived="false">
        ...
        <td class="buttons">
        <button type="button" class="button" data-type="edit">edit</button>
        <button type="button" class="button" data-type="archive">archive</button>
        <button type="button" class="button" data-type="delete">del</button>
        </td>
      </tr>`;
